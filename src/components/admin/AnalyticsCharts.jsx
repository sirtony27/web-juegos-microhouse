    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={dailyStats}>
                                ...
                                />
                                <Line type="monotone" dataKey="visitas" stroke="#E62429" strokeWidth={3} dot={{ r: 4, fill: '#E62429', strokeWidth: 2, stroke: '#fff' }} />
                            </LineChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                ...
                {/* Top Cities */}
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    <h3 className="font-bold text-gray-800 mb-6">Top Ciudades</h3>
                    <div className="space-y-4">
                        {topCities.length > 0 ? topCities.map((city, i) => (
                            <div key={i} className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <span className="w-6 h-6 flex items-center justify-center bg-gray-100 rounded text-xs font-bold text-gray-500">{i + 1}</span>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-bold text-gray-900 w-8 text-right">{city.value}</span>
                                </div>
                            </div>
                        )) : (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Most Viewed Games */}
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    <h3 className="font-bold text-gray-800 mb-6">Juegos Más Vistos</h3>
                    <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                ...
                {/* Most Wanted (Cart) */}
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                    <h3 className="font-bold text-gray-800 mb-6">Mayor Intención de Compra</h3>
                    <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
